...
function AllTokensListService(options) {
    ...
    this._rapidProtectedUpdateTip(this.node.services.beerchaind.height);
    this.node.services.beerchaind.on('tip', this._rapidProtectedUpdateTip.bind(this));
    ...
    return async.waterfall([function (callback) {
        ...
        dataFlow.allContracts.forEach(function (contract) {
            dataFlow.contracts.push({
                ...
                icon: contract.icon ? contract.icon : null,
                verified: contract.verified ? contract.verified : null
            });
        });
