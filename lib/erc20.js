...
Erc20Controller.prototype.getInfo = function(req, res) {
    ...
    return async.waterfall([function (callback) {
        ...
        return res.jsonp({
            ...
            icon: returnData.contract.icon,
            description: returnData.contract.description,
            verified: returnData.contract.verified,
...
Erc20Controller.prototype.getAccountTransfers = function(req, res) {

    var self = this,
        addr = req.params.addr,
        offset = req.query.offset,
        limit = req.query.limit,
        queryOptions = self._formatQueryOptions({limit: limit, offset: offset, address: addr}),
        dataFlow = {
            contract: null,
            countTransfers: 0,
            transfers: []
    ...
    return async.waterfall([function (callback) {
        ...
        return self.erc20TransferRepository.getCountAccountTransfers(addr, {}, function (err, count) {
        ...
        return self.erc20TransferRepository.fetchAccountTransfers(addr, queryOptions, function (err, transfers) {
...
Erc20Controller.prototype.getVerifiedTokens = function(req, res) {

    var self = this;

    return self.erc20ContractsRepository.fetchAllContractsVerified(function (err, results) {

        if (err) {
            return self.common.handleErrors(err, res);
        }

        return res.jsonp({count: results.length, items: results});
