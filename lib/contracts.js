...
function ContractsController(node, opts) {
    this.node = node;
    this.common = new Common({log: this.node.log});
    this.contractsInfo = Object.create(null);
    this.contractCodeRepository = opts.contractCodeRepository;
}
...
ContractsController.prototype.getContractCode = function(req, res) {

    var self = this,
        address = req.params.contractaddress;

    return self.contractCodeRepository.getContractCode(address, function (err, data) {
